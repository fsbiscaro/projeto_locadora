...
class MeuTokenJWT
{
    ...
    public function gerarToken($parametro_claims)
    {
        ...
        //Public Claims
        $objPayload->email_usuario = $parametro_claims->email_usuario;
        $objPayload->nome_usuario = $parametro_claims->nome_usuario;
        $objPayload->cpf_usuario = $parametro_claims->cpf_usuario;
        $objPayload->data_nascimento_usuario = $parametro_claims->data_nascimento_usuario;
        $objPayload->telefone_usuario = $parametro_claims->telefone_usuario;

        //Private claims
        $objPayload->id_usuario = $parametro_claims->id_usuario;
